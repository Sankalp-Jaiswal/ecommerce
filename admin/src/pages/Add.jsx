...
const Add = ({token}) => {
  ...
  return (
    <form onSubmit={onSubmitHandeler} className='flex flex-col w-full items-start gap-3' action="">
        ...
        <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
            ...
            <div>
                ...
                <input value={price} onChange={(e)=>setprice(e.target.value)} className='w-full max-w-[500px] px-3 py-2' type="number" placeholder='249' required  />
            </div>
